...
def create_wallpaper(song_info, script_dir):
    back_image_path = os.path.join(script_dir, './assets/back.png')
    ...
    top_image_path = os.path.join(script_dir, './assets/top.png')
    top_image = Image.open(top_image_path)
    top_image = top_image.resize((back_width, back_height))

    moon_image_path = os.path.join(script_dir, './assets/moon.png')
    ...
    custom_font_path = os.path.join(script_dir, './assets/font3.ttf')
